...
begin
  ...
  insert into public.accounts
    (id, household_id, name, kind, currency, opening_balance, balance_mode, manual_balance)
  values
    ('e3000000-0000-0000-0000-000000000001', hh_a, 'USD ledger', 'checking', 'USD', 100, 'ledger', null),
    ('e3000000-0000-0000-0000-000000000002', hh_a, 'NIO ledger', 'savings', 'NIO', 200, 'ledger', null),
    ('e3000000-0000-0000-0000-000000000003', hh_a, 'Manual', 'cash', 'USD', 0, 'manual', 77),
    ('f3000000-0000-0000-0000-000000000001', hh_b, 'Other household', 'checking', 'CLP', 0, 'ledger', null);
end
$$;
