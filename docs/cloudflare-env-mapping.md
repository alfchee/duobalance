...
| `NEXT_PUBLIC_BILLING_ENABLED`          | Environment Variable          | `[vars]`   | flag   | Client mirror of the flag for UI gating (`useBillingEnabled`/`BillingGate`). Same value as above; redeploy to flip              |
